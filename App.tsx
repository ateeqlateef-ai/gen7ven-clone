  ...
  <section className="py-24 md:py-32 px-4 relative overflow-hidden">
    <div className="max-w-6xl mx-auto p-10 md:p-24 bg-gradient-to-br from-blue-700 via-indigo-700 to-blue-800 rounded-[2.5rem] md:rounded-[4rem] text-center relative shadow-2xl shadow-blue-900/30 overflow-hidden group">
      ...
      <div className="relative z-10 space-y-8">
        <h2 className="text-4xl md:text-6xl font-black text-white tracking-tight animate-fade-up">Ready to scale your business?</h2>
        <p className="text-blue-100 text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed animate-fade-up stagger-1">
          Join the 150+ global brands that have accelerated their digital growth with Gen7ven's high-performance engineering.
        </p>
        <div className="pt-4 animate-fade-up stagger-2">
          <a 
            href="contact.html" 
...
const SectionHeader = ({ badge, title, subtitle, centered = true }: { badge: string, title: string, subtitle?: string, centered?: boolean }) => (
  <div className={`mb-16 ${centered ? 'text-center max-w-3xl mx-auto' : 'max-w-2xl text-left'}`}>
    ...
    <h2 className="text-3xl md:text-5xl font-black text-white mb-6 tracking-tight leading-[1.1] animate-fade-up stagger-1">
      {title}
    </h2>
    {subtitle && (
      <p className="text-slate-400 text-base md:text-xl leading-relaxed font-light animate-fade-up stagger-2">
        {subtitle}
      </p>
    )}
  </div>
  ...
  <div className="bg-slate-950">
    ...
    <section className="py-24 px-6 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          { title: "UI/UX Experience", icon: "fa-pencil-ruler", desc: "User research and interface designs that prioritize engagement and retention.", features: ["User Psychology", "Interactive Prototyping", "Design Systems", "Accessibility"] },
          ...
          { title: "Mobile Engineering", icon: "fa-mobile-screen", desc: "Cross-platform mobile apps that deliver native-level performance and feel.", features: ["iOS & Android", "React Native", "Offline-First", "Push Notifications"] },
          ...
          { title: "Search SEO", icon: "fa-magnifying-glass-chart", desc: "Data-driven SEO strategies that dominate rankings and drive high-intent traffic.", features: ["Technical SEO", "Content Strategy", "Performance Audit", "Backlink Strategy"] },
          { title: "AI & Data Solutions", icon: "fa-brain", desc: "Integrating Generative AI and predictive analytics to future-proof your product.", features: ["LLM Integration", "Data Visualization", "ML Workflows", "Custom Chatbots"] }
        ].map((service, i) => (
    ...
    <section className="relative pt-48 pb-24 border-b border-slate-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <h1 className="text-5xl md:text-8xl font-black text-white mb-8 tracking-tighter leading-none">
          Architects of <span className="text-gradient">Innovation</span>
        </h1>
        <p className="text-slate-400 text-lg md:text-2xl max-w-3xl leading-relaxed font-light">
          We are a multidisciplinary team of engineers and designers dedicated to pushing the boundaries of the digital frontier.
        </p>
      </div>
    </section>
    ...
    <section className="py-24 px-6 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center mb-32">
        ...
        <div className="space-y-10">
          <SectionHeader badge="Our Story" title="Extreme technical excellence from the ground up." centered={false} />
...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Using FormSubmit.co for direct email delivery to the specified recipient
      const response = await fetch("https://formsubmit.co/ajax/mason.liam1122@gmail.com", {
        method: "POST",
        headers: { "Content-Type": "application/json", "Accept": "application/json" },
        body: JSON.stringify({
          ...formData,
          _subject: `New Project Enquire from ${formData.fullName}`,
          _template: "table"
        })
      });
      if (response.ok) {
    ...
    <div className="bg-slate-950">
      <section className="relative pt-48 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <p className="text-slate-400 text-lg md:text-2xl max-w-3xl leading-relaxed font-light">
            Ready to build something extraordinary? Fill out the form below and our team will get back to you within 24 hours.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20">
          <div className="lg:col-span-4 space-y-12 order-2 lg:order-1">
            <div className="space-y-10">
              <h3 className="text-[10px] font-black text-blue-500 uppercase tracking-[0.2em] mb-10">Direct Connect</h3>
              <div className="flex gap-8 group">
                ...
                <div>
                  <h4 className="text-white font-extrabold text-base mb-1">Email Our Team</h4>
              ...
              <div className="flex gap-8 group">
                ...
                <div>
                  <h4 className="text-white font-extrabold text-base mb-1">Innovation Tower</h4>
                  <p className="text-slate-400 font-medium text-sm leading-relaxed">Level 24, Tech District<br/>London, United Kingdom</p>
                </div>
              </div>
            </div>
            
            <div className="p-10 bg-blue-600/5 border border-blue-500/10 rounded-[2.5rem] relative overflow-hidden group">
               <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 blur-3xl rounded-full transition-all group-hover:scale-150"></div>
               <h4 className="text-white font-black mb-4 relative z-10 uppercase text-xs tracking-widest">Global Operations</h4>
            ...
            {status === 'SUCCESS' ? (
              <div className="bg-slate-900/40 border border-slate-800 p-12 md:p-20 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl text-center animate-scale-up">
                ...
                <button 
                  ...
                  className="px-12 py-5 bg-blue-600 text-white font-black rounded-full hover:bg-blue-700 transition-all active:scale-95"
                >
                  Return to Form
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="bg-slate-900/40 border border-slate-800/80 p-8 md:p-16 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl backdrop-blur-md animate-fade-up">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8">
                  <div className="mb-8">
                    <label className="block text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-3 px-1">Full Name</label>
                    <input 
                      type="text"
                      placeholder="e.g. Alexander Pierce"
                      className={`w-full bg-slate-950/80 border ${errors.fullName ? 'border-red-500/50' : 'border-slate-800'} rounded-2xl px-6 py-4 md:py-5 text-slate-200 hover:border-blue-500/50 focus:outline-none focus:ring-4 focus:ring-blue-500/10 transition-all duration-300 placeholder:text-slate-700 font-medium`}
                  ...
                  <div className="mb-8">
                    <label className="block text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-3 px-1">Email Address</label>
                    <input 
                      type="email"
                      placeholder="alex@enterprise.com"
                      className={`w-full bg-slate-950/80 border ${errors.email ? 'border-red-500/50' : 'border-slate-800'} rounded-2xl px-6 py-4 md:py-5 text-slate-200 hover:border-blue-500/50 focus:outline-none focus:ring-4 focus:ring-blue-500/10 transition-all duration-300 placeholder:text-slate-700 font-medium`}
                ...
                <div className="mb-12">
                  <label className="block text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-3 px-1">Message</label>
                  <textarea 
                    rows={6}
                    placeholder="Describe your vision, goals, and timeline..."
                    className={`w-full bg-slate-950/80 border ${errors.message ? 'border-red-500/50' : 'border-slate-800'} rounded-2xl px-6 py-4 md:py-5 text-slate-200 hover:border-blue-500/50 focus:outline-none focus:ring-4 focus:ring-blue-500/10 transition-all duration-300 placeholder:text-slate-700 resize-none font-medium leading-relaxed`}
                ...
                {status === 'ERROR' && (
                  <p className="mt-8 text-center text-red-400 font-bold animate-pulse">
                    <i className="fa-solid fa-triangle-exclamation mr-3"></i>
                    Submission failed. Please email us directly at hello@gen7ven.agency.
                  </p>
                )}
              </form>
            )}
...
// --- Shared Internal Content Components ---
...
const ServicesPreview = () => (
  <section className="py-24 md:py-32 px-6 max-w-7xl mx-auto">
    <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-20 gap-10">
      <SectionHeader 
        badge="Expertise" 
        title="Solutions for ambitious digital products." 
        centered={false}
      />
      <a href="services.html" className="text-blue-500 hover:text-blue-400 font-extrabold flex items-center group text-lg pb-4 transition-colors">
        Full List <i className="fa-solid fa-arrow-right-long ml-3 group-hover:translate-x-2 transition-transform"></i>
      </a>
    </div>
